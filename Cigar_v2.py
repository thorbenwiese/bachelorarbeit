...
class CigarAlignment(object):
  ...
  def cigar_to_tp(self):
    ...
    tp_aln = TracePoint_v2.TracePointAlignment(self.seq1, self.seq2, self.delta, tp=tp, start_seq1=self.start_seq1, start_seq2=self.start_seq2)
    return tp_aln # TODO set instance variable self.tp = tp
