...
\[\frac{104}{38} \approx 2.74 \frac{\text{Bit}}{\text{Symbol}}\]
...
Der durchschnittliche Bitverbrauch für ein Symbol beträgt 
\[\frac{99}{38} \approx 2.61 \frac{\text{Bit}}{\text{Symbol}}\]
...
\begin{figure}[h]
	...
	\end{axis}
	\end{tikzpicture}
	\caption{Bitverbrauch der naiven binären Kodierung des CIGAR-Strings}\label{fig:cig-bin}
\end{figure}
...
\begin{figure}[h]
	...
	\addlegendentry{Mittelwert binäre Kodierung};
...
Im Mittel benötigt die naive binäre Kodierung 170 Bit, die unäre Kodierung 121 Bit und die Huffman-Kodierung 37 Bit.
