...
Wenn die Edit-Distanz $e$ mit der Einheitskostenfunktion bekannt ist, kann ein optimales Alignment in $O(e^2)$ Zeit berechnet werden \cite{gsa-skript}.%TODO Seite?
...
Jedes Paar von zu alignierenden Substrings kann in $O(e^2)$ Zeit berechnet werden. Für eine erwartete Fehlerrate von $\varepsilon$ gilt dann $e \leq \varepsilon\Delta$ \cite[S. 41-42]{gsa-skript}. 
