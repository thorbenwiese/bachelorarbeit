...
%TODO Abbildungstitel in den Text
Die gemessenen Werte der Häufigkeitsverteilung der Kodierung der CIGAR-Strings sind in Tabelle \ref{bits-result} enthalten und in Abbildung \ref{cigar-coding} grafisch dargestellt.
