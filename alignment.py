...
class Alignment(object):
    def __init__(self, seq1, seq2, delta, cigar):
        self.seq1 = seq1
        self.seq2 = seq2
        self.delta = delta
        self.cigar = cigar
    ...
    def cig_to_align(self, seq1, seq2, cigar):
        ...
        for j in cigar_pattern.findall(cigar):
            ...
            if cig_symbol == 'M':
                ...
                #middle += calculate_middle(seq1[tmp1:tmp1 + cig_count], seq2[tmp2:tmp2 + cig_count])
        ...
        alignment = Alignment(seq1_align, seq2_align, delta, cigar)

        print "Gesamtalignment:\n"
        print numbers(alignment.seq1)
        print alignment.seq1
        #print alignment.mid
        print alignment.seq2
        print numbers(alignment.seq2)
        print ""
        return alignment
    ...
    # Entfernung von '-'
    def align_to_seq(self, align):
        seq = align.replace("-", "")
        return seq


    # Anzahl an Buchstaben in Sequenz
    def count_letters(self, seq):
        letter_count = 0
        indel_count = 0
        for k in seq:
            if k.isalpha():
    ...
    def calculate_middle(self, seq1, seq2):
        middle = ""
        c = 0
        add = 0
    ...
    # print Intervalle
    def print_intervals(self, seq1, seq2, alignment, delta, verbose, rebuild_only):
        m = 0
        v_id = 0
        start_seq1 = 0
    ...
    def check_alignment(self, alignment, alignment_new):
        if alignment_new.seq1 == alignment.seq1 and alignment_new.seq2 == alignment.seq2:
            return True
        else:
            sys.stderr.write("Falsche Aufteilung der Sequenzen!")
            print ""
            print alignment_new.seq1
            print alignment.seq1
            print ""
            print alignment_new.seq2
            print alignment.seq2
            sys.exit(1);
...
class TracePoint(object):
    ...
    def rebuild_intervals(self, tp, seq1, seq2, delta, score, verbose):
        ...
        for i in tp.vvalue:
            if i == tp.vvalue[0]:
                ...
                if verbose:
                    ...
                    print aln.seq1
                    print calculate_middle(aln.seq1,aln.seq2)
                    print aln.seq2
...
def main(argv):
    ...
    alignment1 = Alignment(seq1,seq2,delta,cigar)
    ...
    if args.seq1 and args.seq2 and args.delta and args.cigar:
        ...
        print 'Delta:', delta
        print ""
        alignment = Alignment.cig_to_align(seq1, seq2, cigar)
        tp = Alignment.print_intervals(seq1, seq2, alignment, delta, verbose,rebuild_only)
    ...
    # Ohne CIGAR
        ...
        if rebuild_only:
            ...
            if verbose:
                ...
                print 'Delta:', delta
                print ""
                print alignment1.numbers(alignment.seq1)
                print alignment.seq1
                print alignment1.calculate_middle(alignment.seq1,alignment.seq2)
                print alignment.seq2
                print alignment1.numbers(alignment.seq2)
                print ""
            tp = alignment1.print_intervals(seq1,seq2,alignment,delta,verbose,rebuild_only)
        else:
            print '\nSequenz 1:', seq1
            print 'Sequenz 2:', seq2
            print 'Delta:', delta
    ...
    # Zufällige Sequenzen
        ...
        for i in range(0,int(args.random[0])*2,2):
            ...
            if verbose:
                print aln.seq1
                print Alignment.calculate_middle(aln.seq1, aln.seq2)
                print aln.seq2
                print "Score:", aln.score
                print ""
            score = aln.score

            tp = Alignment.print_intervals(random_seq_list[i],random_seq_list[i+1],aln,delta,verbose,rebuild_only)
    else:
